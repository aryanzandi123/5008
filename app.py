...
def get_pathway_interactors(pathway_id):
    ...
    # Query PathwayInteraction for all interactions in this pathway
    pw_interactions = PathwayInteraction.query.filter_by(pathway_id=pathway.id).all()
    ...
    for pwi in pw_interactions:
        ...
        # Get both proteins in the interaction
